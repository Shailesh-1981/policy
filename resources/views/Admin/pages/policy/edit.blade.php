                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body p-4">
                            <form id="editPolicy" onsubmit="return false;">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="policy_number" class="form-control"
                                        value="{{ $data->policy_number }}" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="policy_type" class="form-control" required>
                                        ...
                                        <option value="health" @selected($data->type == 'health')>Health Insurance</option>
                                        <option value="vehicle" @selected($data->type == 'vehicle')>Vehicle Insurance</option>
                                        <option value="life" @selected($data->type == 'life')>Life Insurance</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="premium_amount" class="form-control"
                                        value="{{ $data->premium_amount }}" required>
                                    <small class="text-muted">Policy premium amount</small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Coverage Details</label>
                                    <textarea name="coverage_details" class="form-control" rows="3" required>  {{ $data->coverage_details }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control" required>
                                        ...
                                        <option value="canceled" @selected($data->status == 'canceled')>Canceled</option>
                                    </select>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 200) {
                                toastr.success("Policy update successfully!", "Success", {
                                    closeButton: true,
                                    progressBar: true,
                                    timeOut: 3000
                                });
